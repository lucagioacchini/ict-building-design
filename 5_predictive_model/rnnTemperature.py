# # LSTM model for Average Internal Temperature Forecasting
...
# Scale data in the (0,1) range, save the scalers, split the dataset and the target array in the training and test ones
...
# Load the saved scalers and descale the predictions array
...
# Resize the dataset, roll it, scale it and split into train and test ones
...
plt.plot(val_y_hat[:,2], label='Predictions', linestyle='-.', color = 'steelblue', linewidth=2)
plt.xlabel('Timesteps')
plt.ylabel('Internal Average Temperature [\u00B0C]')
plt.legend()
plt.xlim(0,END-START-1)
plt.grid(linestyle='--')
plt.savefig('../fig/overTemperature.png', transparent=True)
plt.close()
# -
...
plt.plot(val_y_hat[:,2], label='Predictions', linestyle='-.', color = 'steelblue', linewidth=1.5)
plt.xlabel('Timesteps')
plt.ylabel('Internal Average Temperature [\u00B0C]')
plt.legend()
plt.xlim(0,END-START-1)
plt.grid(linestyle='--')
plt.savefig('../fig/underTemperature.png', transparent=True)
plt.close()
# -
...
plt.savefig('../fig/regressionTemperature.png', transparent=True)
plt.close()
...
plt.ylabel('MSE')
plt.xlabel("Epochs")
plt.plot(history.history['loss'], label = 'Train', color='steelblue', linewidth=2, linestyle='-.')
plt.plot(history.history['val_loss'], label = 'Test', color='orangered', linewidth=2)
plt.legend()
plt.grid(linestyle='--')
plt.xlim(-2,100)
plt.ylim(0)
plt.savefig('../fig/lossTemperature.png', transparent=True)
plt.close()
